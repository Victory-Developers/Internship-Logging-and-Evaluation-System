...
To be continued...
5. **Supervisor Review Workflow** – workflow for workplace and academic supervisors to review logbooks and provide comments.
6. **Academic Evaluation Module** – collection of final evaluations, grades, and remarks from academic supervisors.
7. **Weighted Score Computation** – algorithmic calculation of an overall score based on logbooks, reviews, and evaluations.
8. **Dashboards & Reporting** – endpoints exposing summary statistics, progress charts, and downloadable reports for administrators.

> ⚙️ The backend will be built with Django, providing RESTful APIs. Frontend and deployment will be addressed in subsequent phases.
