        ...
        <>                      
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '20px', marginBottom: '30px' }}>
            ...
            <div style={cardStyle}>                  
              ...
              <button style={buttonStyle} onClick={() => navigate('/admin/users?status=pending')}>Manage Users</button>                                                              
            </div>                       
            ...
            {recentActivity.length === 0 ? (                                                                                                                                         
              ...
              <ul style={{ listStyle: 'none', padding: 0 }}>                                                                                                                         
                {recentActivity.map((item, index) => (                       
                  <li key={index} style={{ padding: '10px 0', borderBottom: index < recentActivity.length - 1 ? '1px solid #ddd' : 'none', display: 'flex', justifyContent:          
'space-between' }}>                                
